...

{
    ...
    void Start()
    {
        ...
        if (rollButton)
        {
            // Elimina cualquier duplicado previo
    ...
    public void Roll()
    {
        Debug.Log("[GachaSystem] Roll invocado"); // 👈 Ver cuántas veces se imprime
...

    {
        ...
        db.IncrementOwned(picked.Id, picked.Name, picked.Rarity, 1);
